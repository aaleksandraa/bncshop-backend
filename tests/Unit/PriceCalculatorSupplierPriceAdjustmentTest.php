...
class PriceCalculatorSupplierPriceAdjustmentTest extends TestCase
{
    ...
    public function test_supplier_price_adjustment_is_added_after_margin(): void
    {
        ...
        $this->assertSame(746.96, $result->regularPrice);
        $this->assertSame(20.0, $result->appliedPriceAdjustment);
        $this->assertSame('Startech', $result->supplierName);
    }

    public function test_zero_price_adjustment_does_not_change_regular_price(): void
    {
        $category = Category::factory()->create();
        $supplier = Supplier::query()->create([
